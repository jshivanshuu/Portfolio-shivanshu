...
const Hero = () => {
    return (
        <section id="hero" className="h-screen w-full flex flex-col justify-center items-center bg-primary text-secondary relative overflow-hidden">
            ...
            >
                <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 rounded-xl blur opacity-45 group-hover:opacity-95 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                <div className="relative p-[2px] bg-primary ring-1 ring-gray-900/5 rounded-xl leading-none flex items-center justify-center">
                    <span className="absolute inset-0 rounded-xl overflow-hidden">
                        <span className="absolute inset-[-100%] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)] animate-[spin_2s_linear_infinite] opacity-70 block w-[400%] h-[400%] top-[-150%] left-[-150%]"></span>
                    </span>
                    <div className="relative z-20 flex flex-col items-center bg-primary p-6 rounded-lg w-full h-full">
                        ...
                        <div className="flex justify-center gap-6 mt-8">
                            ...
                            <motion.a
                                whileHover={{ scale: 1.1 }}
                                whileTap={{ scale: 0.95 }}
                                href="https://drive.google.com/file/d/1q_Aciey6MVDc1HQv2OciHp-erB0WmY0M/view?usp=sharing"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-3 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 hover:border-accent/50 transition-colors"
                            >
